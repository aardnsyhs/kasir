...
$sulistyo_sql = "SELECT * FROM `sulistyo_pelanggan` LIMIT $start, $per_page";
...
$total_data_query = "SELECT COUNT(*) as total FROM `sulistyo_pelanggan`";
...
$sulistyo_pelanggan = mysqli_query($conn, $sulistyo_sql);
$sulistyo_badge= ["Gold"=>"warning","Silver"=>"secondary", "Bronze"=>"dark",];
?>
<!DOCTYPE html> 
<html lang="en">
<head>
    <title>Yan's Cafe | Pelanggan</title>
</head>
<body class="d-flex">
    <?php
    $active_page = 'master-pelanggan';
    include "sidebar.php";
    ?>
<main>
    <div class="pt-3 ms-5 me-0 pe-5 scrollarea">
        <div class="row">
            <div class="col">
                <h2>Pelanggan</h2>
                <a class="btn btn-primary" href="tambah-pelanggan.php">
                    <i class="bi bi-person-add"></i> Tambah Daftar Pelanggan
                </a>
                    ...
                    <tr>
                        <td>
                            ...
                            <form class="d-flex mt-2" role="search" method="post">
                                    <div class="mb-2 d-flex align-items-center" style="margin-left: 640px;">
                                        Search
                ...
                <div id="container">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php while ($sulistyo_row = $sulistyo_pelanggan->fetch_assoc()): ?>
...
<script>
    ...
    xhr.open('GET', 'search/master-pelanggan.php?keyword=' + keyword.value, true);
    xhr.send();
});
</script>
</body>
