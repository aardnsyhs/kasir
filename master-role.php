...
$sulistyo_sql = "SELECT * FROM `role` LIMIT $start, $per_page";
...
$total_data_query = "SELECT COUNT(*) as total FROM `role`";
...
$sulistyo_role = mysqli_query($conn, $sulistyo_sql);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Yan's Cafe | Role</title>
</head>
<body class="d-flex">
<?php
$active_page = 'master-role';
include "sidebar.php";
?>
<main>
    <div class="container pt-3 ms-5 me-0 pe-5 scrollarea">
        <div class="row">
            <div class="col">
                <h2>Data Role</h2>
                    <a class="btn btn-primary" href="tambah-role.php">
                        <i class="bi bi-person-add"></i> Tambah Data Role
                    </a>
                    <div class="mt-3">
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <form class="d-flex" role="search" method="post">
                                        <div class="mb-2 d-flex align-items-center" style="margin-left: 151px;">
                                            Search
                                            <input class="ms-2 form-control form-control-sm" type="search" id="keyword" name="keyword" placeholder="Cari Daftar Role" autocomplete="off">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php while ($sulistyo_row = $sulistyo_role->fetch_assoc()): ?>
                                <tr class="text-center align-middle">
                                    <td><?= $sulistyo_row['id_role']; ?></td>
                                    <td><?= $sulistyo_row['nama_role']; ?></td>
                                    <td>
                                        <a  class="btn btn-success" href="ubah-role.php?id=<?= $sulistyo_row['id_role']?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                        <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                                        </svg> Edit</a> 
                                        <a class="btn btn-danger" href="hapus-role.php?id=<?= $sulistyo_row['id_role']?>">
...
<script>
    ...
    xhr.open('GET', 'search/master-role.php?keyword=' + keyword.value, true);
    xhr.send();
});
</script>
</body>
